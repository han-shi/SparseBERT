...
def prepare_model_and_optimizer(args, device):
    ...
    model = BertForPreTraining(config, args.lamb)
    ...
    optimizer_grouped_parameters = [
        {'params': [p for n, p in param_optimizer if
                    not (any(nd in n for nd in mask) or any(nd in n for nd in no_decay))], 'weight_decay': 0.01},
        {'params': [p for n, p in param_optimizer if any(nd in n for nd in no_decay)], 'weight_decay': 0.0},
        {'params': [p for n, p in param_optimizer if any(nd in n for nd in mask)], 'weight_decay': 0.0}]
    # , 'lr': 1e-5
    ...
    if args.resume_from_checkpoint:
        if args.phase2 or args.init_checkpoint:
            ...
            for iter, item in enumerate(checkpoint['optimizer']['param_groups']):
                ...
                checkpoint['optimizer']['param_groups'][iter]['grad_averaging'] = True
                checkpoint['optimizer']['param_groups'][iter]['max_grad_norm'] = 1.0
...
def main():
    ...
    # # edit by jh
    # args.input_dir='hdf5_lower_case_1_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5/books_wiki_en_corpus'
    # args.config_file='bert_config.json'
    # args.bert_model='bert-base-uncased'
    # args.output_dir='results/checkpoints'
    # args.train_batch_size=8192
    # args.max_seq_length=128
    # args.max_predictions_per_seq=20
    # args.max_steps=1563
    # args.warmup_proportion=0.2843
    # args.num_steps_per_checkpoint=200
    # args.learning_rate=6e-3
    # args.seed=12345
    # args.fp16=True
    ...
    if args.do_train:
        ...
        while True:
            ...
            # print('whether initialized:{}'.format(torch.distributed.is_initialized()))
            # print('the world size is{}'.format(torch.distributed.get_world_size()))
            # print('the num of file is {}'.format(num_files))
            ...
            train_sampler = RandomSampler(train_data)
            train_dataloader = DataLoader(train_data, sampler=train_sampler,
                                          batch_size=args.train_batch_size * args.n_gpu, num_workers=8,
                                          pin_memory=True)
            ...
            for f_id in range(f_start_id + 1, len(files)):
                ...
                for step, batch in enumerate(train_iter):
                    ...
                    loss, mask = model(input_ids=input_ids, token_type_ids=segment_ids, attention_mask=input_mask,
                    ...
                    if global_step >= args.max_steps:
                        ...
                        if is_main_process():
                            dllogger.log(step=(epoch, training_steps / args.gradient_accumulation_steps,),
                    ...
                    if global_step >= args.max_steps or training_steps % (
                        ...
                        if is_main_process() and not args.skip_checkpoint:
                            ...
                            print('sparsity:', mask_np.sum() / 12 / 128 / 128)
